...
public class TowerCannon {
	...
	// tartget the nearest obj
	private Enemy acquireTarget() {
		Enemy closet = null;
		float closetDistance = 10000;
		for (Enemy e : enemies) {
			if (isInRange(e) && findDistance(e) < closetDistance) {
	...
	public void shoot() {
		timeSinceLastShot = 0;
		//projectile.add(new ProjectileIce(quickLoad("bullet"), target, x + TILE_SIZE / 2 - TILE_SIZE / 4,
		//		y + TILE_SIZE / 2 - TILE_SIZE / 4, 32, 32, 600, 10));
	}
